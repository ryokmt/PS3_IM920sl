...
//    if (PS3.getAnalogHat(LeftHatX) > 135 || PS3.getAnalogHat(LeftHatX) < 125 || PS3.getAnalogHat(LeftHatY) > 128 || PS3.getAnalogHat(LeftHatY) < 124 || PS3.getAnalogHat(RightHatX) > 127 || PS3.getAnalogHat(RightHatX) < 126 || PS3.getAnalogHat(RightHatY) > 128 || PS3.getAnalogHat(RightHatY) < 124) {
...
//      Serial.print(latestLeftX == PS3.getAnalogHat(LeftHatX));
//      Serial.print(latestLeftY == PS3.getAnalogHat(LeftHatY));
//      Serial.print(latestRightX == PS3.getAnalogHat(RightHatX));
//      Serial.print(latestRightY == PS3.getAnalogHat(RightHatY));
